...
import { ArrowLeft, Edit, Mail, Clock, Award, BookOpen } from 'lucide-react';
import { motion } from 'framer-motion';
import { Card, CardContent } from '@/components/ui/card';
import LessonTopicsList from './lessonTopics/LessonTopicsList';
import LessonTopicsList from '@/components/lessonTopics/LessonTopicsList'; // 👈 Importado
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* 👇 Nueva sección para historial de temas */}
          <LessonTopicsList student={student} />
        </div>
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">{t('students.nextLessonTopic')}</p>
                  <div className="flex items-start gap-2 mt-1">
                    ...
                    <div className="bg-muted rounded-md px-3 py-2 text-sm text-muted-foreground w-full">
                      {student.nextLessonTopic || t('students.noTopic')}
                    </div>
                  </div>
                </div>
              </div>
